...
class TopDownISBI2023Dataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def evaluate(self, outputs, res_folder, metric='EPE', **kwargs):
        ...
        allowed_metrics = ['MRE_std_i2','MRE_i2','MRE_wise_point_i2','SDR_2_i2','SDR_2.5_i2','SDR_3_i2','SDR_4_i2','SDR_10_i2']
