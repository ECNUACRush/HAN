...
#        print('heatmap:',heatmap.shape)
    ...
    #print('pose_result[keypoints]:',len(pose_results[0]['keypoints']))
    return pose_results, returned_outputs
...
def vis_pose_result(model,
    ...
    if (dataset_info is None and hasattr(model, 'cfg')
            and 'dataset_info' in model.cfg):
        dataset_info = DatasetInfo(model.cfg.dataset_info)
    #print('data_info:',model.cfg.dataset_info)
    ...
    palette = np.array([[255, 128, 0], [255, 153, 51], [255, 178, 102],
                            ...
                            [51, 255, 51], [0, 255, 0], [0, 51, 255],#[12,12,220],#[0, 51, 255],
                            [255, 0, 0], [255, 255, 255]])
    if dataset_info is not None:
        skeleton = []
        pose_kpt_color = palette[[17] * 38]  # TODO: change 19 to number of lanmarks
