_base_ = [
    ...
    '../_base_/datasets/Adult.py'
    
    # './mmpose/configs/_base_/default_runtime.py',
    # './mmpose/configs/_base_/datasets/ISBI2015.py'
]
checkpoint_config = dict(interval=100)
evaluation = dict(interval=1, metric=['MRE_i2','MRE_std_i2','SDR_2_i2','SDR_2.5_i2','SDR_3_i2','SDR_4_i2','SDR_10_i2'], save_best='MRE_i2')
...
channel_cfg = dict(
    ...
    inference_channel=list(range(10)))
