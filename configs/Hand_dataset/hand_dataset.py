_base_ = [
    ...
    '../_base_/datasets/Hand_dataset.py'
...
channel_cfg = dict(
    ...
    inference_channel=list(range(37)))
...
model = dict(
    ...
    backbone=dict(
        ...
        topks=[1, 4, 8, 16, -2],#[1, 4, 16, 4, 4], 1, 4, 8, 16, 16
        side_dwconv=5,
...
train_pipeline = [
    ...
    dict(type='TopDownRandomFlip', flip_prob=0.3),
...
datatype='TopDownHandDataset'
data_root = './Hand_dataset/'
data = dict(
